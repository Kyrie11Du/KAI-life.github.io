...
> PhD position in coarse-grained simulations（https://pages-andrienko-10bcaa2045685d6c9509367c68ef5f030a701b968e1f8e8.pages.mpip-mainz.mpg.de/）

> A PhD position in computational materials science is immediately available at the the Max Planck Institute for Polymer Research, Mainz, in the group of Denis Andrienko (https://andrienko.pages.mpip-mainz.mpg.de/pages). The project is related to screening of materials for organic light emitting diodes and is a part of a collaboration with MERCK Electronics. The position is available starting from April 1st, 2025.
> 
> We welcome applications of highly qualified graduates with a Master's degree in Physics, Chemistry, Chemical Engineering, or Materials Science. Experience in Linux, C++, and python will be considered as an advantage.
> 
> Your application should contain the following documents:
> 
> cover letter outlining the background of the application
> resume / CV
